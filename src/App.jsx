...
const SHEETS_API_URL = "https://script.google.com/macros/s/AKfycbwLRgIt-swW3AIlLd6trCL_EmHDPLXZ2r6MZeuXO4EPJEQ7EhIO5iodG5eQJ4S6twB6/exec";
...
const ATHLETES_SEED = [
  { id: "a1", name: "Léa Fontaine", initials: "LF", tone: ACCENT, username: "lea", password: "lea123", nutritionEnabled: true,
    ...
    hormonalTrackingEnabled: true, cycleInfo: { averageCycleLengthDays: 28, regularity: "regular", contraception: "none", isPregnantOrPostpartum: false, isPerimenopausal: false }, enabledSymptoms: { ...DEFAULT_ENABLED_SYMPTOMS } },
  { id: "a2", name: "Karim Bensaïd", initials: "KB", tone: AMBER, username: "karim", password: "karim123", nutritionEnabled: false,
    profile: { weight: 74, height: 179, age: 31, sex: "m", goal: "perf" }, diet: [] },
  { id: "a3", name: "Sofia Marchetti", initials: "SM", tone: BLUE, username: "sofia", password: "sofia123", nutritionEnabled: false,
    profile: { weight: 61, height: 170, age: 24, sex: "f", goal: "perf" }, diet: [],
    hormonalTrackingEnabled: false, cycleInfo: { averageCycleLengthDays: 30, regularity: "somewhat_irregular", contraception: "combined_pill", isPregnantOrPostpartum: false, isPerimenopausal: false }, enabledSymptoms: { ...DEFAULT_ENABLED_SYMPTOMS } },
];
