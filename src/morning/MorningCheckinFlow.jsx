...
//
// hasAutoHrvData transmis à QuestionnaireForm : vrai uniquement si un test
// orthostatique automatique (capteur BLE/caméra) a produit un rapport —
// permet à QuestionnaireForm de savoir s'il doit proposer la saisie
// manuelle de VFC/FC repos (tier Rapide, ou test sauté/refusé en
// Standard/Avancé) plutôt que d'imposer une double saisie.
// ============================================================================
...
export default function MorningCheckinFlow({ athleteId, onComplete, cmjStep: CmjStep, sessionType, loadDeltaPercent, adaptiveReadinessScore, cmjHistory, setCmjHistory, t, lang }) {
  ...
  if (step === STEP.QUESTIONNAIRE) {
    return (
      <QuestionnaireForm
        hasAutoHrvData={!!orthostaticResult?.report}
